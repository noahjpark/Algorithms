public interface List<T extends Comparable<T>> {
    ...
    /*
    returns a new List object containing the k smallest elements in the List.
    ...
    /*
    returns a new List object containing the k largest elements in the List.
    If k is less than 1 then null should be returned. If k is greater than or equal
    to the size of the list then the entire list should be returned.
     */
...
// example is add(1, "jello")
//    ["snake", "house", "hello", "dog", null, null, null, null]                temp = "dog"
//                                  i
//
// 1: ["snake", "house", "hello", "hello", null, null, null, null]
//                          i
// 2: ["snake", "house", "house", "hello", null, null, null, null]
//                 i
// DONE WITH LOOP
// e: ["snake", "jello", "house", "hello", null, null, null, null]
//                                  lp   -> lp++
//    ["snake", "jello", "house", "hello", "dog", null, null, null]
/*

T temp = a[lastPlace];
for(int i  = lastPlace; i > index; i++){
    a[i] = a[i-1];
}
a[index] = element;
lastplace++;
